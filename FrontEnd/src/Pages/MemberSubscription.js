...
export const MemberSubscription = () => {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:8081/getAllListMembers?userId=${sessionStorage.getItem("userId")}`, {
         method: "GET",
         headers: {
            ...
            <div style={{
                ...
                {membersLists.map(el=>(
                    <ul style={{
                        ...
                        <li>{el.email}
                        <Button variant="contained" color="secondary" onClick={deleteMember(el.id)}>Supprimer</Button>
                        </li>
                    </ul>
                ))}
                <Box sx={{
                ...
                <Button onClick={()=>setNewMember(true)} variant="contained" color="primary">Ajouter un nouveau membre</Button>
                {newMember && (
                    <FormControl sx={{
                        marginTop: "5%"
                    }}>
                        ...
                        <Button onClick={createNewMember} variant="contained" color="primary">Ajouter</Button>
                    </FormControl>
                )}
                </Box>
            </div>
