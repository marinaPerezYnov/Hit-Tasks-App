...
class TasksRepository extends ServiceEntityRepository
{
    ...
    public function save(Tasks $tasks, bool $flush = false): void
    {
        $this->getEntityManager()->persist($tasks);
    ...
    public function remove(Tasks $tasks, bool $flush = false): void
    {
        $this->getEntityManager()->remove($tasks);
