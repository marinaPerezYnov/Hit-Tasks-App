...
final class Version20240521180822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Tasks (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name LONGTEXT  DEFAULT NULL, status INT DEFAULT NULL, task_value INT DEFAULT NULL, date DATETIME DEFAULT NULL, time VARCHAR(255) DEFAULT NULL,PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
